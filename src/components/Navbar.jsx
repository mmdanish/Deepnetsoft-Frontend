  ...
  return (
    <>
      <nav className="relative bg-black text-white px-7 sm:px-8 py-5 flex items-center justify-between z-50">
        ...
        <div className="absolute bottom-[-20px] left-5 flex items-end">
          <div className="w-14 h-14 sm:w-16 sm:h-16">
            <img src={Logo} alt="Deep Net Logo" className="w-full h-full" />
          </div>
          {/* Hide Name on Mobile */}
          <h1 className="hidden sm:block text-xl sm:text-2xl uppercase leading-none ml-2 mb-2">
            <span className="text-[#32A0FF]">Deep</span>
            <span className="text-white"> Net</span>
            <br />
            <span className="text-[#857878] text-2xl sm:text-3xl block">
              Soft
            </span>
          </h1>
        </div>

        {/* Navigation Links - Stays at the Right End */}
